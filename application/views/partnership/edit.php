...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Edit <?php echo $partnership->nama_partnership; ?></li>
    </ol>
  </nav>
</div>
<!-- End Page Title -->
  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="card-title mb-4">
        <h4>Form Edit Partnership</h4>
        <p class="text-muted">Silakan ubah form berikut untuk mengedit data partnership.</p>
      </div>
      ...
      <form action="<?php echo base_url('partnership/update'); ?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_partnership" value="<?php echo $partnership->id_partnership; ?>">
        ...
        <div class="row mb-3">
          <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="nama_partnership" name="nama_partnership" 
                   value="<?php echo set_value('nama_partnership', $partnership->nama_partnership); ?>" required>
            ...
            <?php if ($partnership->logo_partnership): ?>
              <div class="mt-2">
                <img src="<?php echo base_url('assets/img/partnership/' . $partnership->logo_partnership); ?>" 
                     class="img-thumbnail" style="max-width: 200px;" alt="Logo Partnership">
                <small class="text-muted d-block">Logo saat ini. Kosongkan jika tidak ingin mengubah.</small>
              </div>
            <?php endif; ?>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-12">
            <button type="submit" class="btn btn-primary">
              <i class="bi bi-save"></i> Update Partnership
            </button>
