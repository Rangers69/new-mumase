  ...
  <div class="card">
    <div class="card-body pt-4">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h5 class="card-title mb-1">Edit Data Mata Pelajaran</h5>
                ...
                <div class="col-md-8">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="nama_mapel" id="nama_mapel" 
                           ...
                           value="<?php echo set_value('nama_mapel', $mapel->nama_mapel); ?>">
                  </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-select" name="active" id="active" required>
                      ...
                      <option value="1" <?php echo set_select('active', '1', $mapel->active == 1); ?>>Aktif</option>
                      <option value="0" <?php echo set_select('active', '0', $mapel->active == 0); ?>>Tidak Aktif</option>
                    </select>
                  </div>
