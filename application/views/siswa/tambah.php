  ...
  <div class="card">
    <div class="card-body pt-4">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h5 class="card-title mb-1">Tambah Data Siswa</h5>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir" 
                         required value="<?php echo set_value('tanggal_lahir'); ?>">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="tahun_masuk" id="tahun_masuk" 
                         ...
                         value="<?php echo set_value('tahun_masuk', date('Y')); ?>">
                </div>
              ...
              <div class="col-md-12">
                ...
                <div class="input-group">
                  ...
                  <textarea class="form-control" name="alamat" id="alamat" rows="3" required 
                            placeholder="Contoh: Jl. Merdeka No. 123, Jakarta Pusat"><?php echo set_value('alamat'); ?></textarea>
                </div>
                    ...
                    <?php if (!empty($kelas)): ?>
                      <?php foreach ($kelas as $kelas_item): ?>
                        <option value="<?php echo $kelas_item->id_kelas; ?>" 
                                <?php echo set_select('id_kelas', $kelas_item->id_kelas); ?>>
              ...
              <div class="col-md-8">
                ...
                <div class="input-group">
                  ...
                  <select class="form-select" name="jurusan" id="jurusan" required>
                    ...
                    <option value="Desain Komunikasi Visual" <?php echo set_select('jurusan', 'Desain Komunikasi Visual'); ?>>Desain Komunikasi Visual</option>
                  </select>
                </div>
